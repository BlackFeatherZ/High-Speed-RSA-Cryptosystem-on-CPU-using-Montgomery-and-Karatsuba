...
uint32_t add(bn_t* re,bn_t* num1,uint32_t len1, bn_t* num2,uint32_t len2);
void bn_mul2(bn_t *a, bn_t *b, bn_t *c, uint32_t digits);
void Karatsuba(bn_t* re,bn_t* num1,uint32_t len1, bn_t* num2,uint32_t len2);
void print_bn(bn_t *b,uint32_t digits);

void reverse(bn_t* num1,int l,int r);
void check(bn_t* a,bn_t*b,uint32_t digits);
void rec_kara(uint32_t* a, int one, uint32_t* b, int two, uint32_t* r);
/*
